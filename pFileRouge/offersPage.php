                            ...
                            while($row = mysqli_fetch_array($result)){
                                ...
                                <div class='container row' id='offers_Divs' >
                                    ...
                                    <div class='col'>
                                        ...
                                        <h4>". $row['nomPost'] . "</h4>
                                        <p>". $row['description'] ."</p><a id='rightLink' href='detailProjet.php?id=$id' name='voirPlus'><i id='rightIcon' class='fa-solid fa-arrow-right-long d-flex justify-content-end'></i></a>
                                    </div>
                                </div>";
