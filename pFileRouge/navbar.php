  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="nav-item">
        <a class="nav-link active nav-item" aria-current="page" href="offersPage.php">Offres</a>
        </li>
      </ul>
     ...
     <div id="frstLi" class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" id="drpdownNav">
            <li><a class="dropdown-item lilink" href="marketingPage.php">Profile</a></li>
            <hr>
            <li><a class="dropdown-item lilink" href="designPage.php">Design</a></li>
            <hr>
            <li><a class="dropdown-item lilink" href="logout.php">Déconnecter</a></li>
          </ul>
</div>
